...
let tutteLeNotizie = [
    ...
    },
    {
        ...
        paragrafi: `<p>Lorem 3 sport ipsum dolor sit amet, consectetur adipiscing elit. Phasellus ac tortor erat. Nunc et venenatis orci, id gravida
        urna. Donec bibendum tempus vehicula. Mauris vestibulum nisi sit amet nulla varius, vitae mattis diam suscipit. Nulla
        dictum massa suscipit, vehicula dui nec, euismod augue. Orci varius natoque penatibus et magnis dis parturient montes,
        nascetur ridiculus mus. Curabitur lobortis pellentesque ultricies. Suspendisse ut egestas libero, sit amet vehicula
        orci.</p>
    ...
    {
        categoria: "gossip",
        titolo: "Titolo 2 gossip",
        paragrafi: `<p>Lorem 2 gossip ipsum dolor sit amet, consectetur adipiscing elit. Phasellus ac tortor erat. Nunc et venenatis orci, id gravida
        urna. Donec bibendum tempus vehicula. Mauris vestibulum nisi sit amet nulla varius, vitae mattis diam suscipit. Nulla
        dictum massa suscipit, vehicula dui nec, euismod augue. Orci varius natoque penatibus et magnis dis parturient montes,
        nascetur ridiculus mus. Curabitur lobortis pellentesque ultricies. Suspendisse ut egestas libero, sit amet vehicula
        orci.</p>
...
function filtraNews(strIndicatore) {
    if (strIndicatore == "tutteLeNotizie") {
        ...
        for (objArticolo of tutteLeNotizie) {
            ...
            line += `</div>`;
            divArticoli.innerHTML += line;
            //Animazione applicata alla sezione **Notizie dall'estero**
            animSez('.articoli .notizie-estero');
        }
    }
}

//Creo i button in html per filtrare le notizie
...
//Function animazione che richiamo in filtraNews() sopra
function animSez(getDiv) {
    let start = 0;
    let idInterval = null
    let selectedDivs = sectionMostraNews.querySelectorAll(getDiv);
    for (objDiv of selectedDivs) {
        objDiv.hidden = true;
    };
    function showDiv() {
        if (start < selectedDivs.length) {
            selectedDivs[start].hidden = false;
            start++;
        } else {
            clearInterval(idInterval);
        }
    }
    idInterval = setInterval(showDiv, 1000);
}